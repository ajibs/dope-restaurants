...
exports.resize = async (req, res, next) => {
  ...
  // generate unique name and save reference to what photo is stored
...
exports.createStore = async (req, res) => {
  // set the location data to be a point; needed for indexing locations
...
exports.updateStore = async (req, res) => {
  ...
  // redirect them to the store and tell that it worked
};
