...
// you can also use navigator.geolocation.getCurrentPosition
...
function typeAhead(search) {
  ...
  searchInput.on('input', function () {
    ...
    _axios2.default.get('/api/search?q=' + this.value).then(function (res) {
      ...
      searchResults.innerHTML = _dompurify2.default.sanitize('<div class="search__result">No reults for <strong>' + _this.value + '</strong> found!</div>');
    }).catch(function (err) {
      console.error(err);
    });
  });
